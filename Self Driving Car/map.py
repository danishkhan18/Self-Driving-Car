...
class MyPaintWidget(Widget):
    ...
    def ch(self,touch):
          parent = Game()
          parent.goal_x = touch.x
          parent.goal_y = touch.y
          parent.update(touch)
...
class CarApp(App):
    ...
    def build(self):
        ...
        reversebtn = Button(text = 'Reverse', pos =(3 * parent.width, 0))
        startbtn = Button(text = 'Start', pos =(4 * parent.width, 0))
        destinationbtn = Button(text = 'Destination', pos =(5 * parent.width, 0))
        clearbtn.bind(on_release = self.clear_canvas)
        reversebtn.bind(on_release = self.reverse)
